...
if (Boolean.valueOf(isDayFailed)) {
    WebUI.verifyElementPresent(findTestObject('Result/font_Input data for Day is incorrect format'), 0)
}

if (Boolean.valueOf(isMonthFailed)) {
    WebUI.verifyElementPresent(findTestObject('Result/font_Input data for Month is incorrect format'), 0)
}

if (Boolean.valueOf(isYearFailed)) {
    WebUI.verifyElementPresent(findTestObject('Result/font_Input data for Year is incorrect format'), 0)
}
